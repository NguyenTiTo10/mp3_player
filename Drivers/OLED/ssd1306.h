...
char ssd1306_WriteChar(char ch, SSD1306_Font_t Font, SSD1306_COLOR color, uint8_t flag); // modifed (add flag for case scrolling case that happen not at the end of screen)
char ssd1306_WriteString(char* str, SSD1306_Font_t Font, SSD1306_COLOR color);
void ssd1306_ScrollString(char* str, uint8_t x, uint8_t y, SSD1306_Font_t Font, SSD1306_COLOR color, uint8_t flag); // custom
void ssd1306_SetCursor(uint8_t x, uint8_t y);
void ssd1306_Line(uint8_t x1, uint8_t y1, uint8_t x2, uint8_t y2, SSD1306_COLOR color);
void ssd1306_DrawArrow(uint8_t x1, uint8_t y1, uint8_t x2, uint8_t y2, uint8_t gap, SSD1306_COLOR color); // custom
